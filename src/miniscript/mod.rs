        ...
        T: Translator<Pk, Q, FuncError>,
    {
        ...
        for data in Arc::new(self.clone()).post_order_iter() {
            ...
            let new_term = match data.node.node {
                ...
                Terminal::Sha256(ref x) => Terminal::Sha256(*x),
                Terminal::Hash256(ref x) => Terminal::Hash256(*x),
                Terminal::Ripemd160(ref x) => Terminal::Ripemd160(*x),
                Terminal::Hash160(ref x) => Terminal::Hash160(*x),
