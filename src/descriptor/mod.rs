...
impl<Pk: MiniscriptKey> Descriptor<Pk> {
    ...
    pub fn sanity_check(&self) -> Result<(), Error> {
        match *self {
            Self::Bare(ref bare) => bare.sanity_check(),
            Self::Pkh(_) => Ok(()),
            Self::Wpkh(ref wpkh) => wpkh.sanity_check(),
            Self::Wsh(ref wsh) => wsh.sanity_check(),
            Self::Sh(ref sh) => sh.sanity_check(),
            Self::Tr(ref tr) => tr.sanity_check(),
        }
    }
